...
# ターゲット座標
TARGET_LAT = 38.266157
TARGET_LNG = 140.858558

# タイムアウトと動作関連定数
TIMEOUT_PHASE_0 = 2 * 60
TIMEOUT_PHASE_1 = 30
# Offset成立を優先する。総合13分のうち、Phase3に最低3分を残せる上限。
TIMEOUT_PHASE_2 = 4 * 60 + 20
...
PHASE0_DROP_TO_PHASE1_DELAY_SEC = 30.0
...
SEARCH_ROTATION_INNER_SPEED = 28
...
PHASE3_TURN_OUTER_SPEED = 65
PHASE3_TURN_INNER_SPEED = 42
PHASE3_HEADING_DEADBAND_DEG = 14.0
PHASE3_GPS_FALLBACK_DEADBAND_DEG = 18.0
PHASE3_GPS_FALLBACK_TURN_SCALE = 1.0
PHASE3_MOTOR_LOOP_INTERVAL = 0.40
PHASE3_LARGE_ERROR_DEG = 80.0
PHASE3_LARGE_ERROR_OUTER_SPEED = 60
PHASE3_LARGE_ERROR_INNER_SPEED = 35
...
HEADING_OFFSET_LEARN_MAX_RESIDUAL_DEG = 12.0
...
PHASE2_CALIB_MAX_TIME = 30.0
PHASE2_CALIB_STABLE_SEC = 1.5
PHASE2_CALIB_ROTATE_SPEED = 55
PHASE2_OFFSET_LEG_MAX_TIME = 12.0
PHASE2_OFFSET_CONTROL_SETTLE_TIME = 2.0
PHASE2_OFFSET_MIN_DISTANCE_M = 5.0
PHASE2_OFFSET_MIN_SAMPLES = 6
PHASE2_OFFSET_MIN_PATH_EFFICIENCY = 0.72
PHASE2_OFFSET_MAX_BNO_SPREAD_DEG = 12.0
PHASE2_OFFSET_MAX_SUBSEGMENT_DIFF_DEG = 20.0
PHASE2_TURN_INTERVAL = 3.0
PHASE2_SPEED = 100
PHASE2_OFFSET_SPEED = 90
PHASE2_OFFSET_HOLD_KP = 0.5
PHASE2_OFFSET_HOLD_DEADBAND_DEG = 2.5
PHASE2_OFFSET_HOLD_MAX_DELTA = 15.0
PHASE2_OFFSET_TURN_SPEED = 55
PHASE2_OFFSET_TURN_DEADBAND_DEG = 8.0
PHASE2_OFFSET_TURN_CONFIRM_COUNT = 3
PHASE2_OFFSET_MODE_COLLECT = "collect"
PHASE2_OFFSET_MODE_TURNAROUND = "turnaround"
